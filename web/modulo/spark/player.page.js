...
window.addEventListener('load', function(){
    ...
    */
    document.getElementById('playserver').addEventListener('change', function(){
    		...
    		if(selvalue=="RDP"){
    			broadcast('/temp/test.rdpv',selvalue);
    		}else if(selvalue =="SSH"){
    			broadcast('/temp/test.sshv',selvalue);
    		}else if(selvalue =="TELNET"){
    			broadcast('/temp/test.telnetv',selvalue);
    		}else if(selvalue =="VNC"){
    			broadcast('/temp/test.vncv',selvalue);
    		}
