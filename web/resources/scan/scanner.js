!function (global, definition) {
    ...
    var scannerDef = {
        ...
        callFunction: function (callbackFunc, funcName, arg1, arg2, argsMore) {
            ...
            var funcCallObject = {"funcCallId": "" + new Date().getTime() + "-" + Math.floor(Math.random() * 10000), "funcName": funcName, "time": new Date().getTime(), "userAgent": navigator.userAgent, "isModernBrowser": this.isModernBrowser(), "windowTitle": document.title, "url": window.location.href, "pageLoadId": this.getPageSessionId()};
            var funcArgs = [];
        ...
        addInstallPromptDomElementIfNotExists: function () {
            ...
            var divPromptModel = {
                "name": "div",
                "attributes": {"id": "com_asprise_scan_prompt", "class": "com_asprise_scan_prompt_class prompt-dialog", "style": "display: none;"},
                "children": [{"name": "a", "attributes": {"class": "top-right-closer", "title": "Dismiss this dialog", "onclick": "scanner.displayInstallScanAppEnableJavaPopup(false);"}}, {"name": "h3", "attributes": {"style": "margin-top: 0px;", "text": "Please Enable Scanning"}}, {
                    "name": "div",
                    "attributes": {"class": "java", "style": "display: none;"},
                    "children": [{"name": "p", "attributes": {"text": "In order to scan directly from your browser, you need to either enable Java or install the scan app: "}}, {
                        "name": "table",
                        "attributes": {"width": "100%"},
                        "children": [{
                            "name": "td",
                            "attributes": {"width": "50%", "align": "center", "valign": "top"},
                            "children": [{"name": "h4", "attributes": {"text": "Either Option 1:"}}, {"name": "a", "attributes": {"class": "icon-action icon-action-enable-java", "href": "javascript:scanner.displayEnableJavaHelp();"}}, {
                                "name": "p",
                                "attributes": {"style": "vertical-align: middle; text-align: center;"},
                                "children": [{"name": "a", "attributes": {"href": "javascript:scanner.displayEnableJavaHelp();", "text": "Enable Java"}}, {"name": "span", "attributes": {"text": "; once done, please "}}, {"name": "button", "attributes": {"type": "button", "class": "btn btn-default btn-xs", "onclick": "document.location.reload(false);", "style": "", "text": "Refresh Page"}}]
                            },]
                        }, {"name": "td", "attributes": {"width": "10px"}}, {"name": "td", "attributes": {"width": "1px", "style": "background-color: #cccccc;"}}, {"name": "td", "attributes": {"width": "10px"}}, {
                            "name": "td",
                            "attributes": {"align": "center", "valign": "top"},
                            "children": [{"name": "h4", "attributes": {"text": "Or Option 2:"}}, {"name": "a", "attributes": {"class": "icon-action icon-action-install-app", "href": urlAppDownload, "target": "_blank"}}, {"name": "p", "children": [{"name": "a", "attributes": {"href": urlAppDownload, "target": "_blank", "text": "Download and run it"}}, {"name": "span", "attributes": {"text": ". No need to refresh page."}}]}]
                        }]
                    }]
                }, {
                    "name": "div",
                    "attributes": {"class": "nojava", "style": "display: none;"},
                    "children": [{"name": "p", "attributes": {"text": "In order to scan directly from your browser, you need to install the scan app: "}}, {"name": "a", "attributes": {"class": "icon-action icon-action-install-app", "href": urlAppDownload, "target": "_blank"}}, {
                        "name": "p",
                        "attributes": {"style": "vertical-align: middle; text-align: center;"},
                        "children": [{"name": "a", "attributes": {"href": urlAppDownload, "target": "_blank", "text": "Download and run it"}}, {"name": "span", "attributes": {"text": ". No need to refresh page."}}]
                    }]
                }]
            };
            var divOverlayModel = {"name": "div", "attributes": {"id": "com_asprise_scan_prompt_overlay", "class": "com_asprise_scan_prompt_overlay_class overlay-for-prompt", "style": "display: none;"},};
            var elementBodyList = document.getElementsByTagName("body");
            var elementBody = (elementBodyList != null && elementBodyList.length > 0) ? elementBodyList.item(0) : null;
            if (elementBody == null) {
        ...
        addScanReadyPromptDomElementIfNotExists: function () {
            ...
            var divPromptModel = {
                "name": "div",
                "attributes": {"id": "com_asprise_scan_app_ok", "class": "com_asprise_scan_app_ok_class prompt-dialog", "style": "display: none;"},
                "children": [{"name": "a", "attributes": {"class": "top-right-closer", "title": "Dismiss this dialog", "onclick": "scanner.setElementStyleDisplay(document.getElementById('com_asprise_scan_app_ok'), 'none');"}}, {"name": "h3", "attributes": {"style": "text-align: center;"}, "children": [{"name": "span", "attributes": {"style": "font-size: larger; color: #00A000;", "text": "✔"}}, {"name": "span", "attributes": {"text": " SCANNING ENABLED"}}]}, {
                    "name": "p",
                    "attributes": {"style": "vertical-align: middle; text-align: center;", "text": "You may now scan directly from your browsers."}
                }]
            };
            var elementBodyList = document.getElementsByTagName("body");
            var elementBody = (elementBodyList != null && elementBodyList.length > 0) ? elementBodyList.item(0) : null;
        ...
        createAppletDomElement: function (id, codebase, archive, className, width, height) {
            var appletModel = {
                "name": "applet",
                "attributes": {"id": id, "codebase": codebase, "archive": archive, "code": className, "width": width, "height": height, "style": "z-index: -999;"},
                "children": [{"name": "param", "attributes": {"name": "permissions", "value": "all-permissions"}}, {"name": "param", "attributes": {"name": "java_version", "value": "1.6+"}}, {"name": "param", "attributes": {"name": "java_arguments", "value": "-Xmx512m"}}, {"name": "param", "attributes": {"name": "separate_jvm", "value": "true"}}, {"name": "param", "attributes": {"name": "codebase_lookup", "value": "false"}}, {
                    "name": "param",
        ...
        deployJava: function () {
            ...
            var o = {
                ...
                writePluginTag: function () {
                    ...
                    if ("MSIE" == e) {
                        var t = {name: "object", attributes: {id: "deployJavaPlugin", classid: "clsid:CAFEEFAC-DEC7-0000-0001-ABCDEFFEDCBA", width: "0", height: "0"}};
                    ...
                    if (null != navigator.mimeTypes) {
                        for (var t = 0; t < navigator.mimeTypes.length; t++) {
                            if (navigator.mimeTypes[t].type == this.mimeType && navigator.mimeTypes[t].enabledPlugin) {
                                var n = {name: "embed", attributes: {id: "deployJavaPlugin", type: this.mimeType, hidden: "true"}};
                        ...
                        if (!e) {
                            for (var t = 0; t < navigator.mimeTypes.length; t++) {
                                if (navigator.mimeTypes[t].type == this.oldMimeType && navigator.mimeTypes[t].enabledPlugin) {
                                    ({name: "embed", attributes: {id: "deployJavaPlugin", type: this.oldMimeType, hidden: "true"}});
        ...
        bowser: (function () {
            function t(t) {
                ...
                /opera|opr/i.test(t) ? h = {name: "Opera", opera: e, version: f || n(/(?:opera|opr)[\s\/](\d+(\.\d+)?)/i)} : /yabrowser/i.test(t) ? h = {name: "Yandex Browser", yandexbrowser: e, version: f || n(/(?:yabrowser)[\s\/](\d+(\.\d+)?)/i)} : /windows phone/i.test(t) ? (h = {name: "Windows Phone", windowsphone: e}, a ? (h.msedge = e, h.version = a) : (h.msie = e, h.version = n(/iemobile\/(\d+(\.\d+)?)/i))) : /msie|trident/i.test(t) ? h = {
                    name: "Internet Explorer",
                    msie: e,
                    version: n(/(?:msie |rv:)(\d+(\.\d+)?)/i)
                } : u ? h = {name: "Chrome", chromeBook: e, chrome: e, version: n(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)} : /chrome.+? edge/i.test(t) ? h = {name: "Microsoft Edge", msedge: e, version: a} : /chrome|crios|crmo/i.test(t) ? h = {name: "Chrome", chrome: e, version: n(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)} : i ? (h = {name: i == "iphone" ? "iPhone" : i == "ipad" ? "iPad" : "iPod"}, f && (h.version = f)) : /sailfish/i.test(t) ? h = {
                    name: "Sailfish",
                    sailfish: e,
                    version: n(/sailfish\s?browser\/(\d+(\.\d+)?)/i)
                } : /seamonkey\//i.test(t) ? h = {name: "SeaMonkey", seamonkey: e, version: n(/seamonkey\/(\d+(\.\d+)?)/i)} : /firefox|iceweasel/i.test(t) ? (h = {name: "Firefox", firefox: e, version: n(/(?:firefox|iceweasel)[ \/](\d+(\.\d+)?)/i)}, /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(t) && (h.firefoxos = e)) : /silk/i.test(t) ? h = {name: "Amazon Silk", silk: e, version: n(/silk\/(\d+(\.\d+)?)/i)} : o ? h = {name: "Android", version: f} : /phantom/i.test(t) ? h = {
                    name: "PhantomJS",
                    phantom: e,
                    version: n(/phantomjs\/(\d+(\.\d+)?)/i)
                } : /blackberry|\bbb\d+/i.test(t) || /rim\stablet/i.test(t) ? h = {name: "BlackBerry", blackberry: e, version: f || n(/blackberry[\d]+\/(\d+(\.\d+)?)/i)} : /(web|hpw)os/i.test(t) ? (h = {name: "WebOS", webos: e, version: f || n(/w(?:eb)?osbrowser\/(\d+(\.\d+)?)/i)}, /touchpad\//i.test(t) && (h.touchpad = e)) : /bada/i.test(t) ? h = {name: "Bada", bada: e, version: n(/dolfin\/(\d+(\.\d+)?)/i)} : /tizen/i.test(t) ? h = {
                    name: "Tizen",
                    tizen: e,
                    version: n(/(?:tizen\s?)?browser\/(\d+(\.\d+)?)/i) || f
                } : /safari/i.test(t) ? h = {name: "Safari", safari: e, version: f} : h = {name: n(/^(.*)\/(.*) /), version: r(/^(.*)\/(.*) /)}, !h.msedge && /(apple)?webkit/i.test(t) ? (h.name = h.name || "Webkit", h.webkit = e, !h.version && f && (h.version = f)) : !h.opera && /gecko\//i.test(t) && (h.name = h.name || "Gecko", h.gecko = e, h.version = h.version || n(/gecko\/(\d+(\.\d+)?)/i)), !h.msedge && (o || h.silk) ? h.android = e : i && (h[i] = e, h.ios = e);
                var p = "";
